...
export class LoginController {
  ...
  @ApiResponse({ status: 400, description: 'Email e Senha não podem ser vazios'})
  @ApiResponse({ status: 409, description: 'Dados de usuário incompletos ou Senha incorreta'})
